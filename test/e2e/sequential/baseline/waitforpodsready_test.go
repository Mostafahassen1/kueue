...
<<<<<<< HEAD:test/e2e/customconfigs/waitforpodsready_test.go
package customconfigse2e
=======
package sequentialbaseline
>>>>>>> test: split e2e customconfigs into baseline and extended:test/e2e/sequential-baseline/waitforpodsready_test.go
