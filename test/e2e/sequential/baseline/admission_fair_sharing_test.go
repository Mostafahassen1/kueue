...
<<<<<<< HEAD
<<<<<<< HEAD:test/e2e/customconfigs/admission_fair_sharing_test.go
package customconfigse2e
=======
package sequentialbaseline
>>>>>>> test: split e2e customconfigs into baseline and extended:test/e2e/sequential-baseline/admission_fair_sharing_test.go
=======
package baseline
